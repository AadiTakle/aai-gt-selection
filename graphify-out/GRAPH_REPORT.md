...
## Corpus Check
- 29 files · ~62,287 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 334 nodes · 318 edges · 31 communities (21 shown, 10 thin omitted)
- Extraction: 95% EXTRACTED · 4% INFERRED · 1% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.89)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2e6f5d5f`
...
1. `Separating Selection Effect from Program Effect` - 26 edges
2. `Backend and Admissions Algorithm Designs` - 17 edges
3. `Synthetic Simulation Specification` - 15 edges
4. `Paper Deep Dive 4` - 12 edges
5. `Future Allocation, Aid, and Auditable Lottery Research` - 11 edges
6. `Paper Deep Dive 3` - 11 edges
7. `Paper Deep Dive 2` - 10 edges
8. `Reviewer, Rubric, and Fairness Validation` - 9 edges
9. `3. Rubric Validation Stages` - 9 edges
10. `Paper Deep Dive 1` - 9 edges
...
Cohesion: 0.07
Nodes (32): Canonical Document Precedence, Mandatory Contributor Workflow, E-001 Public GT Reporting Lacks Credible Comparison, E-006 Ability and Achievement Remain Predictive, Decision Rule Matters More Than Extra Test, Concept A Selection-First, Concept B Evaluation-First, Concept C Integrated Selection and Evaluation (+24 more)
...
Cohesion: 0.05
Nodes (36): Advanced STEM Readiness Outcome, Aid and Treatment Package, Algorithmic Guardrails, Assignment and Market-Design Finding, Backend and Admissions Research Report, Backend Research Direction, Benefit-Targeting Effect, Core Statistical Estimands (+28 more)
...
Cohesion: 0.18
Nodes (10): Iteration 0 — 2026-07-18, Iteration 1 — 2026-07-18, Iteration 2 — 2026-07-18, Iteration 3 — 2026-07-18, Iteration 4 — 2026-07-18, Iteration Log, Next Research Clusters, Overnight Backend and Admissions Research Log (+2 more)
...
## Knowledge Gaps
- **228 isolated node(s):** `Week`, `Task`, `tasks`, `weeks`, `views` (+223 more)
