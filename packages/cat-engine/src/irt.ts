...
/**
 * Item Response Theory primitives (2PL / 3PL). Pure numeric functions; no I/O,
 * no framework, no DB. Recovered from the reverted CAT stack (commit 2b458cb)
 * and made structure-agnostic (no adaptive-routing coupling).
 */
...
export function responseLogLikelihood(
  theta: number,
  irt: IrtParameters,
  correct: boolean,
): number {
