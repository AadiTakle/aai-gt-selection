import type { ScoredResponse, ThetaEstimate } from './types';

import { probabilityCorrect, itemInformation, responseLogLikelihood } from './irt';

/**
 * Ability (theta) estimation: EAP over a quadrature grid (primary) and MLE via
 * Fisher scoring (secondary). Recovered from commit 2b458cb. Pure; no I/O.
 */
 ...
 * Robust for short tests and all-correct / all-incorrect strings where the MLE
 * diverges. Returns the posterior mean and posterior SD (as SE).
 */
