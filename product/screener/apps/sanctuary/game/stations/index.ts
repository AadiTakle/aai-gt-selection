 ...
 *
 * The whole directory reaches `Game.tsx` through these names and nothing else:
 *
 ...
 *   PIPS                                                 how many questions a visit asks, so the round
 *                                                        length and the lights counting it cannot diverge
 *
