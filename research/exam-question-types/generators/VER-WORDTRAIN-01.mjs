...
function buildItem(entry, index) {
  ...
  return {
    ...
    provenance: {
      ...
      validator: itemValidatorVerdicts(entry, options, correctKey, difficulty, correct, cards),
    },
    syntheticOnly: true,
    validated: false,
  };
...
function itemValidatorVerdicts(entry, options, correctKey, difficulty, correct, cards) {
