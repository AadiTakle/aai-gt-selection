...
--
-- Recorded as decision D-018 (Proposed, not ratified). Born-synthetic throughout
...
comment on function app.exam_compute_outcome(uuid) is
  'DEMOTED (D-018, Proposed): reference implementation only. NOT an authority and no longer '
...
comment on function api.exam_get_next_item(uuid, uuid) is
  'FALLBACK selection only (D-018, Proposed). BUILD_PLAN §3 assigns selection to '
