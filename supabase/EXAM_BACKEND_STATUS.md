...
amended 2026-07-25 with the ownership split (§8, D-019).**
...
decisions **D-017** and **D-019** both remain *Proposed*.
...
> reasoning behind it. It was **implemented** as decision **D-019** (still *Proposed*, still
...
2. ~~**Single source of truth is unresolved** (§6).~~ **Resolved 2026-07-25 by D-019** — see §8.
...
4. ~~**The variable-length battery is effectively fixed-length under the shipped default
   policy.**~~ **Resolved 2026-07-25 by D-019** — see §8.2. The diagnosis stands exactly as
...
## 8. The ownership split (2026-07-25, decision D-019, *Proposed*)

**One migration: `supabase/migrations/20260725050000_exam_outcome_ownership.sql`.** It implements
the §6 recommendation. D-019 in `docs/governance/DECISION_LOG.md` records the decision, the
...
Nothing was dropped, so reversal is additive. See D-019 for the ratified wording; operationally:
