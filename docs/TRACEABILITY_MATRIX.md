...
| H9 | Explain and contest decisions | Reason traces and correction are specified; substantive appeal/re-entry scope remains unresolved | Applicant explanation, correction, appeal-scope, and re-entry tests | Student/family advocate | Partially specified |
...
| PRD-001 | Specify the Track A/Track B admissions prototype | R1, R5, R7–R10, H1, H2, H4, H7, H9, H10 | Convert confirmed product decisions into a bounded, testable four-week synthetic MVP while deferring R2, R3, R6, and remaining R4 evaluation work | PRD preserves Track A, defines profile-aware Track B invitation and dual-route Snapshot eligibility, separates allocation/research/finance, includes roles, states, requirements, acceptance criteria, metrics, risks, and open decisions; appeal, allocation, and causal-claim contradictions remain unresolved | Product owner | Team | In progress | None |
...
| RES-009 | Specify cumulative cohort pooling and growth-multiple decomposition | R2–R4, R6–R8, R10, H3, H5, H6, H8 | Show how repeated randomized cohorts refine uncertainty while separating observed growth from GT-attributable growth | Reports and simulation define cohort-specific/pooled ITTs, sequential inference, version heterogeneity, and total/counterfactual/attributable multiplier reporting | Evaluation owner | Team | Implemented | None |
