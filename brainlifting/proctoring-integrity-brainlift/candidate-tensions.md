...
- *H.K. through Farwell v. Google* held COPPA preempted the under-13 plaintiff's BIPA claims while her older co-plaintiffs' claims continued, while *Jones v. Google* (9th Cir.) held COPPA does not preempt parallel state claims as a general matter and *Hartman v. Meta* (S.D. Ill.) reached that result on BIPA itself.
- *Patterson v. Respondus* refused to enforce a Washington choice-of-law clause because it would leave the plaintiffs without recourse under BIPA, while *Thakkar v. ProctorU* enforced an Alabama clause and disposed of the BIPA claims — two proctoring vendors, the same defensive move, opposite outcomes.
- The *G.T. v. Samsung* court called the detection-versus-recognition question "another issue with law on both sides" and recorded a split in the cases before choosing a side, while *Zellmer v. Meta* (9th Cir.) states the identification requirement as a matter of definition without noting any division in the authority.
- *Rivera v. Google* holds a face-geometry scan derived from a photograph is covered notwithstanding BIPA's photograph exclusion, while RCW 19.375.010 excludes photographs, video, and any data generated from them from Washington's definition entirely.
- 16 C.F.R. § 312.2 makes a photograph or video containing a child's image personal information in itself, while the FTC's 2025 final rule declined to treat facial data as such and 740 ILCS 14/10 excludes photographs from the biometric definition outright.
- 16 C.F.R. § 312.6(a)(2) gives the parent a standing right to direct deletion of the session record and § 312.6(b) immunises the operator for good-faith disclosure in response, while Viñas-Guasch et al. name that same adult as a source of possible active help — and no located statute, regulator, or court addresses the conflict.
- The Future of Privacy Forum counts 116 student-privacy laws in 40 states while the Public Interest Privacy Center counts nearly 150 in 47 states and DC, and neither reconciles its date range or inclusion criteria against the other.
- New York's Commissioner of Education bars every school in the state, public and nonpublic, from purchasing or using facial recognition technology, while Cal. Bus. & Prof. Code § 22584 and 105 ILCS 85 regulate the same category of vendor by contract, notice, and deletion duties instead of prohibiting it.
- 18 U.S.C. § 2258A imposes a reporting duty on a "provider" that obtains actual knowledge of apparent child exploitation material, while no located authority resolves whether an at-home proctoring operator is a provider — the unanswered question is itself the exposure.
- The Department of Education states private and parochial K–12 schools generally fall outside FERPA and *Gonzaga v. Doe* forecloses a private damages action under it, while the state student-data statutes nobody names carry the seven- and thirty-day breach clocks that actually bind a vendor.
- The Edmodo stipulated order required deletion of the models and algorithms built from children's data, while 16 C.F.R. § 312.8(b) calibrates only the *safeguards* to operator size and leaves the designated employee, annual assessment, testing, and annual review required at any size.
