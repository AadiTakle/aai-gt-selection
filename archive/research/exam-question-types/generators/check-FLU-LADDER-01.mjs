...
for (const it of items) {
  ...
  try {
    const regen = normalizeBankItem(genItem({ n: lev.n, extra: lev.extra, distractorSimilarity: lev.distractorSimilarity, keyPosition: lev.keyPosition, seed: it.provenance.seed }));
