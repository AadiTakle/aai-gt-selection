 ...
 * that deliberately (D-208): the trial is REVIEWABLE, showing what the machine produced and which
 ...
 * up until the child presses Next (STAGE2_REDESIGN_SPEC §4.2, D-208), so a branch now exists and
 ...
 * from, which undercuts the construct it is measuring (D-208).
 *
