...
export const EXAM_TYPE_REGISTRY: readonly ExamRegistryEntry[] = [
  ...
  },
  {
    ...
    blurb: 'Shown a strange, intriguing picture, the child asks as many questions about it as they can and guesses what caused it and what might happen next.',
    ageBands: ['2-3', '4-5', '6-8'],
    itemCount: 120,
    difficultyMin: 1,
    difficultyMax: 20,
    verifier: 'per_type',
    metrics: ['M-ENGAGE', 'M-EXPLORE', 'M-FLEX', 'M-IDEAFLU', 'M-PATH', 'M-PLANFUL', 'M-QUERY', 'M-REV', 'M-RT', 'M-RTFIRST'],
  },
  {
    typeCode: 'CX-sjt-01',
    domain: 'verbal',
  ...
  },
  {
    ...
    blurb: 'Instead of picking a tile, the child BUILDS the missing matrix cell by setting its shape, color and number so every row and column rule holds.',
    ageBands: ['2-3', '4-5', '6-8'],
    itemCount: 120,
    difficultyMin: 1.23,
    difficultyMax: 19.77,
    verifier: 'per_type',
    metrics: ['M-EFF', 'M-ENGAGE', 'M-PATH', 'M-PLANFUL', 'M-RAPIDGUESS', 'M-REV', 'M-RT', 'M-RTFIRST'],
  },
  {
  ...
  },
  {
    ...
    domain: 'verbal',
    title: 'Claim Duel',
    blurb: 'The child props up a claim by dragging the strongest evidence cards to it and knocks down a rival claim by picking its weakest link.',
    ageBands: ['4-5', '6-8'],
    itemCount: 120,
    difficultyMin: 1,
    difficultyMax: 20,
  ...
  },
  {
    ...
    domain: 'spatial',
    title: 'Star Filter',
    blurb: 'The child watches a brief array, remembers only the target-coloured shapes (ignoring the rest), and after a short blank taps where those shapes were.',
    ageBands: ['2-3', '4-5', '6-8'],
    itemCount: 120,
    difficultyMin: 1,
    difficultyMax: 20,
  ...
  },
  {
    ...
    domain: 'spatial',
    title: 'Path Forge',
    blurb: 'The child rotates and drops road tiles to build one continuous path from the start hut to the goal, then the courier walks the route.',
    ageBands: ['2-3', '4-5', '6-8'],
    itemCount: 120,
    difficultyMin: 1,
    difficultyMax: 20,
  ...
  },
  {
    ...
    domain: 'spatial',
    title: 'Shape Smith',
    blurb: 'The child rotates and flips a few puzzle pieces and drops them so they exactly fill the target silhouette with no gaps or overlaps.',
    ageBands: ['2-3', '4-5', '6-8'],
    itemCount: 120,
    difficultyMin: 1,
    difficultyMax: 20,
  ...
  },
  {
    ...
    blurb: 'Read step-by-step building directions, then pick the finished picture that follows every step in order.',
    ageBands: ['2-3', '4-5', '6-8', 'K-1'],
    itemCount: 100,
    difficultyMin: 1,
    difficultyMax: 20,
  ...
  },
  {
    typeCode: 'WM-gate-01',
    domain: 'spatial',
    title: 'Gatekeeper (probed running span / continuous updating)',
    blurb: 'Creatures parade through a gate one at a time and, at unpredictable checkpoints, a guard asks the child to tap back the last few that just passed - then the…',
    ageBands: ['2-3', '4-5', '6-8'],
    itemCount: 120,
    difficultyMin: 1.04,
    difficultyMax: 19.96,
    verifier: 'per_type',
    metrics: ['M-DIFFREACH', 'M-DRIFT', 'M-ENGAGE', 'M-LAPSE', 'M-RAPIDGUESS', 'M-REV', 'M-RT', 'M-RTFIRST', 'M-RTVAR', 'M-SPAN'],
  },
  {
    typeCode: 'WM-gridflash-01',
    domain: 'spatial',
    title: 'Star Grid (simultaneous visuospatial span / change detection)',
    blurb: 'A pattern of coloured stars flashes on a grid all at once, disappears, and after a short delay the child says whether a probed cell is the SAME or CHANGED -…',
    ageBands: ['2-3', '4-5', '6-8', 'K-1'],
    itemCount: 120,
    difficultyMin: 1.04,
    difficultyMax: 19.96,
    verifier: 'per_type',
    metrics: ['M-DIFFREACH', 'M-ENGAGE', 'M-LAPSE', 'M-RAPIDGUESS', 'M-REV', 'M-RT', 'M-RTFIRST', 'M-SPAN'],
  },
] as const;
