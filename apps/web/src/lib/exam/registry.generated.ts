...
//
// Wired: 52 types (fluid_reasoning 12 · quantitative 9 · spatial 19 · verbal 12).
...
export const EXAM_TYPE_REGISTRY: readonly ExamRegistryEntry[] = [
  ...
  },
  {
    ...
    domain: 'verbal',
    title: 'Fib Finder',
    blurb: 'The child reads a few short facts and taps the claim those facts best support.',
    ageBands: ['2-3', '4-5', '6-8'],
    itemCount: 120,
    difficultyMin: 1,
    difficultyMax: 20,
  ...
  },
  {
    ...
    difficultyMax: 20,
    verifier: 'keyed',
    metrics: ['M-RAPIDGUESS', 'M-REV', 'M-RT', 'M-RTFIRST'],
  },
  {
  ...
  },
  {
    ...
    difficultyMax: 20,
    verifier: 'keyed',
    metrics: ['M-EXPLORE', 'M-PATH', 'M-RAPIDGUESS', 'M-REPLAY', 'M-REV', 'M-RT', 'M-RTFIRST'],
  },
  {
  ...
  },
  {
    ...
    domain: 'verbal',
    title: 'Word Machines',
    blurb: 'A tiny invented morphology: the child is shown one labelled creature, then works out what each three-letter morpheme does to it by watching the system work,…',
    ageBands: ['2-3', '4-5', '6-8'],
    itemCount: 468,
    difficultyMin: 1.01,
    difficultyMax: 19.99,
  ...
  },
  {
    ...
    difficultyMax: 20,
    verifier: 'per_type',
    metrics: ['M-EXPLORE', 'M-PATH', 'M-REV', 'M-RT', 'M-RTFIRST'],
  },
  {
