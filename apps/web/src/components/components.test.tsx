...
import { SyntheticPrototypeBanner } from './synthetic-prototype-banner';

describe('application shell boundaries', () => {
  it('renders the persistent synthetic prototype warning', () => {
    render(<SyntheticPrototypeBanner />);
    expect(
      screen.getByText('Synthetic prototype — not a real admissions decision'),
    ).toBeInTheDocument();
  });
